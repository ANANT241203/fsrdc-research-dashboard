document.addEventListener("DOMContentLoaded", function() {
    ...
    function toggleAuthorChart() {
        ...
        Plotly.newPlot('top-authors', [{
            ...
            title: 'Top 10 Authors by FSRDC Outputs (' + chartType.toUpperCase() + ')',
            xaxis: {title: 'Author'},
            yaxis: {title: 'Publications'}
        });
    }
    // Add the toggle button above the authors chart
    const authorSection = document.querySelector('#top-authors').parentNode;
    const authorToggleBtn = document.createElement('button');
    authorToggleBtn.innerText = 'Toggle Author Chart Type';
    authorToggleBtn.style.cssText = "margin-top: 10px; margin-bottom: 20px; padding: 0.5em 1em; font-size: 1em;";
    authorToggleBtn.onclick = toggleAuthorChart;
    authorSection.insertBefore(authorToggleBtn, document.querySelector('#top-authors'));
});
