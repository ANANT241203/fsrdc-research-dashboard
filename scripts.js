...
Plotly.newPlot('cluster-plot', [
    {
        x: [0.95, 0.62, 1.03, 1.08, 0.56, 0.51, 0.89],
        y: [-1.53, -1.14, -1.34, -1.29, -1.63, -1.21, -1.47],
        mode: 'markers',
        name: "Cluster 0",
        type: 'scatter',
        marker: { size: 6 }
    ...
    {
        x: [-1.53, -1.65, -1.33, -1.71, -1.25, -1.19, -1.42],
        y: [0.84, 1.03, 0.89, 0.96, 1.05, 0.91, 0.76],
        mode: 'markers',
        name: "Cluster 1",
        type: 'scatter',
        marker: { size: 6 }
    ...
    {
        x: [0.31, 0.14, 0.45, 0.28, 0.33, 0.10, 0.39],
        y: [0.34, 0.23, 0.47, 0.38, 0.40, 0.19, 0.36],
        mode: 'markers',
        name: "Cluster 2",
        type: 'scatter',
        marker: { size: 6 }
    ...
    title: 'KMeans Clustering of Research Outputs',
    xaxis: { title: 'Principal Component 1' },
    yaxis: { title: 'Principal Component 2' }
});
...
function toggleAuthorChart() {
    ...
    Plotly.newPlot('top-authors', [{
        ...
        y: [46, 30, 26, 22, 22],
        type: chartType,
        marker: {color: chartType === 'bar' ? 'darkgreen' : undefined}
    }], {
        title: 'Top Authors by FSRDC Outputs (' + chartType.toUpperCase() + ')',
        xaxis: {title: 'Author'},
        yaxis: {title: 'Publications'}
    });
}
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    toggleBtn.innerText = 'Toggle Author Chart Type';
    toggleBtn.style.cssText = "margin-top: 10px; margin-bottom: 20px; padding: 0.5em 1em; font-size: 1em;";
    toggleBtn.onclick = toggleAuthorChart;

    const authorSection = document.querySelector('#top-authors').parentNode;
    authorSection.insertBefore(toggleBtn, document.querySelector('#top-authors'));
});
...
var clusterFrames = [
    ...
    Plotly.newPlot('cluster-plot', clusterFrames[0].data, {
