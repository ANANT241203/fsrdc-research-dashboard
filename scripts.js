...
document.addEventListener("DOMContentLoaded", function() {
    ...
    setupChartDropdown('pca-plot-dropdown', 'pca-plot', [
        ...
        document.getElementById('tfidf-kmeans-section').style.display = (type === 'tfidf-kmeans') ? '' : 'none';
        ...
        } else if (type === 'tfidf-kmeans') {
            Plotly.newPlot('pca-plot', [], { title: '' }); // Hide main plot
